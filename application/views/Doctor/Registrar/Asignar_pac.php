                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <div class="col-sm-2 col-md-offset-7">
                                    <a href="<?php echo base_url() ?>Doctor/Asignar_pacInf"><button  type="button" class="btn btn-info"><span class="glyphicon glyphicon glyphicon-search"></span> Pacientes asignados</button></a></div>
                            </div>
                        </div>
 ...
 <?php $incorrecto = $this->session->flashdata('incorrecto');
    ...
    {
    ?>
       <script type="text/javascript">alert('<?php echo $incorrecto?>');</script>
